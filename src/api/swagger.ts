...
docsRouter.get('/api/swagger-docs.json', (req, res) => {
...
docsRouter.use('/api/swagger-docs', swaggerUI.serve);
docsRouter.get('/api/swagger-docs', swaggerUI.setup(swaggerSpec));
